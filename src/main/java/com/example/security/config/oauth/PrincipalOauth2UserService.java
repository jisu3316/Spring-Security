...
public class PrincipalOauth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        System.out.println("userRequest.getClientRegistration(): "+userRequest.getClientRegistration()); // registationId로 어떤 OAuth로 로그인 했는지 확인 가능.
        ...
        String providerId = oAuth2User.getAttribute("sub");  //oauth.getAttributes(): 키값 sub
